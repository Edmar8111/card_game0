...
def home(request):
    ...
    for b in image_db:
        print(b.images.url)
        if b.images.url=='/image_cards/image_0/spotlight.png':
            anima_investida=b.images.url
        if b.images.url=='/image_cards/image_0/exploit.png':
            anima_exploit=b.images.url
        if b.images.url=='/image_cards/image_0/spootlight_glass.png':
            anima_spoot=b.images.url
    for c in cards_db:
        lista_0.append(c.id)
    ...
    return render(request, 'base.html', {'cards_db':cards_db,'verso_card':verso_card,'card_behind':card_behind_img,
                                         ...
                                         'img_investida':anima_investida,'img_exploit':anima_exploit,'img_spoot':anima_spoot,
                                         'life_player':lista_life[1],'life_bot':lista_life[0],
